...
//
// It does not load reference value sets. A [ReferenceValueSet] here is an
// in-memory value; the signed file format, its signature validation and its
// loader are ticket 03.
//
