...
| 2026-09-08T18:16Z | tdx-upgrade | c3-standard-4 TDX, us-central1-a, 20GB pd-balanced, pinned image `ubuntu-2404-noble-amd64-v20260826` | ticket 16: four boots — baseline, `update-grub`, recordfail=1 in grubenv, kernel upgrade — quote+CCEL each, disk state tarball before each reboot | running |
