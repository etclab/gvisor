...
| 2026-08-28T01:23Z | listener | n2d-standard-2 SEV-SNP, us-central1-a | the attested peer in the cloud (~$0.08/h) | STOPPED 02:10Z after the full run (ran ~47 min); disk retained |
| 2026-08-28T01:23Z | relay | e2-small, us-central1-a, public IP | the on-path attacker and the non-confidential peer (~$0.02/h) | STOPPED 02:10Z (ran ~47 min); disk retained |
