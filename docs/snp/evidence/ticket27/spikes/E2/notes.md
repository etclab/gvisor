...
3. **Delivery cost**: The marginal cost of delivering a policy replay to a running sentry is ~1.25 ms (p50), ~1.87 ms (mean). The cost of a first delivery is ~3.2–4.8 ms.
